 ...
 */
package com.mycompany.atomclientserverapplication.client;

import javax.swing.JFrame;
import javax.swing.JButton;
import com.mycompany.atomclientserverapplication.statecode.StateCode;
...
public class AtomClientGUI {

	private JFrame frame;
	private JTextArea meaningPane;
	private JTextField wordField;
	private GETClient atomClient;
	 ...
	 */
	public AtomClientGUI(GETClient client) {
		atomClient =client;
		initialize();
	}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (isValid(word, meaning, StateCode.ADD)) {
					...
					if (confirm == JOptionPane.YES_OPTION) {
						int state = atomClient.add(word, meaning);
		...
		btnQuery.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isValid(word, "", StateCode.QUERY)) {
					String[] resultArr = atomClient.query(word);
		...
		btnRemove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isValid(word, "", StateCode.REMOVE)) {
					...
					if (confirm == JOptionPane.YES_OPTION) {
						int state = atomClient.remove(word);
						if(state == StateCode.UNKNOWN_HOST) {
							JOptionPane.showMessageDialog(frame, "Unknown Host!\nPlease restart with a correct Address and IP.", "Warning", JOptionPane.ERROR_MESSAGE);
						}
						else if (state == StateCode.FAIL) {
