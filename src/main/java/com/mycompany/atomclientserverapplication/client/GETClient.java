...
public class GETClient {
	...
	public static void main(String[] args) {
            GETClient client1 = new GETClient(args[0], Integer.parseInt(args[1]));
			client1.run();
		try {
			// Check port format.
			...
			GETClient client = new GETClient(args[0], Integer.parseInt(args[1]));
			client.run();
	...
	public void run() {
		try {
			this.ui = new AtomClientGUI(this);
